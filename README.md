## Changelog
- 1.1.17 (2026.01.31)
    - 다운로드 시 임시 폴더의 부모 폴더까지 삭제하는 문제 수정
    - 프록시 설정은 다운로드 시점의 가용한 계정에서 가져옴
    - 심볼릭 링크 생성 조건 수정
- 1.1.16 (2026.01.12)
    - 장르별 폴더에 다운로드하는 설정 추가
    - 심볼릭 링크 생성 조건 수정
- 1.1.15 (2025.12.13)
    - N_m3u8dl_RE로 다운로드 시 merge가 안 되는 문제 수정
    - N_m3u8dl_RE로 다운로드 시 자막 파일도 merge
    - 최신 VOD 다운로드 재시도 조건 정리
    - 오타 수정
- 1.1.14 (2025.11.17)
    - 유효하지 않은 심볼릭 링크 예외 처리
- 1.1.13 (2025.10.25)
    - 플러그인 인증 제거
